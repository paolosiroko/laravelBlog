    ...
    <section class="px-6 py-8">
        ...
        <form method="POST" action="/admin/posts" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" 
                id="slug" type="text" placeholder="slug" name="slug" value="{{ old("slug") }}" required>
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" 
                id="thumbnail" type="file" placeholder="thumbnail" name="thumbnail">
            ...
            <div class="mb-4">
                ...
                id="excerpt" rows="4" name="excerpt" placeholder="excerpt..." required>{{ old("excerpt") }}</textarea>
